...
/** True only when all four connection strings are configured -- the same
...
export const hasDatabase = Boolean(
  MIGRATION_DATABASE_URL && MAINTENANCE_DATABASE_URL && API_DATABASE_URL && BOOTSTRAP_DATABASE_URL
);

...
**Reviewed repository commit:** `1d64ca5dc3effa0e5a565d9fcf906d031497ea2d`
...
> **Temporal hygiene note for Evaluation portion of Wave 2 row:** встроенное описание `XFR-D-058 v1.0`/`XFR-D-059 v1.0` отражает исторический Wave 2G checkpoint. Текущее состояние задают более поздние §5.8.1–§5.8.4: `XFR-D-057` разрешает qualitative label-evidence eligibility, `XFR-D-058 v1.1` — human adjudication governance procedure, `XFR-D-059 v1.1` — connected-component grouping/isolation boundary, а `XFR-D-060 v1.0` — conservative correction-history exclusion boundary; named appointments/RBAC, `XFR-D-062`, `XFR-D-071`, source-history/manifest/runtime representation, production-data prerequisites и прочие dependencies Evaluation cluster остаются `OPEN`.

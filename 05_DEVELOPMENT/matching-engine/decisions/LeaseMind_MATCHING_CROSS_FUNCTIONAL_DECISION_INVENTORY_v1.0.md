...
**Reviewed repository commit:** `792d80df16822da94184f8b1f5c6761cfe52a9a3`
...
| №6 Safe Presentation allowlist | `PRODUCT + LEGAL` | `XFR-D-072`, `XFR-D-074` | Field-allowlist governance/evidence prerequisites `PARTIALLY_RESOLVED_BOUNDARY` (`XFR-D-072`); geographic-generalization governance/evidence prerequisites also `PARTIALLY_RESOLVED_BOUNDARY` (`XFR-D-074`); actual rows/fields/transformations/values/levels, `XFR-D-M3`, `XFR-D-075`–`084`, evidence/policy/runtime remain open | `PARTIALLY_RESOLVED_BOUNDARY` |

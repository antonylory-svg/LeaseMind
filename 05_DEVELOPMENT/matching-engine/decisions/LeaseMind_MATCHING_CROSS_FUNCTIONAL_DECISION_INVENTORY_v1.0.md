...
**Reviewed repository commit:** `d1e5eb8fd4a8066cfc2129e4250306ac6a4b4cec`
...
| №6 Safe Presentation allowlist | `PRODUCT + LEGAL` | `XFR-D-072`, `XFR-D-074`, `XFR-D-075`, `XFR-D-076`, `XFR-D-077` | Field-allowlist governance/evidence prerequisites `PARTIALLY_RESOLVED_BOUNDARY` (`XFR-D-072`); geographic-generalization governance/evidence prerequisites also `PARTIALLY_RESOLVED_BOUNDARY` (`XFR-D-074`); combination-risk algorithm governance/evidence-procedure boundary also `PARTIALLY_RESOLVED_BOUNDARY` (`XFR-D-075`); successive-disclosure budget governance/evidence-procedure boundary also `PARTIALLY_RESOLVED_BOUNDARY` (`XFR-D-076`); user-facing safe reason/explanation catalog governance/evidence boundary also `PARTIALLY_RESOLVED_BOUNDARY` (`XFR-D-077`); actual rows/fields/transformations/values/levels/algorithm contents/budget unit/scope key/catalog namespace-value-wording-mapping, `XFR-D-M3`, `XFR-D-039`, `XFR-D-010`, `XFR-D-052`, `XFR-D-078`–`084`, evidence/policy/runtime remain open; Cross-Campaign/multi-user collusion (Safe Presentation Policy §8 сценарий 6) remains unassigned | `PARTIALLY_RESOLVED_BOUNDARY` |

...
Human-approved governance decisions `LeaseMind_MATCHING_DECISION_XFR-D-017_v1.0.md` (Mutual Aggregate qualitative governance/anti-masking/evidence boundary), `LeaseMind_MATCHING_DECISION_XFR-D-018_v1.0.md` (Scoring segment-override governance/evidence boundary), `LeaseMind_MATCHING_DECISION_XFR-D-020_v1.0.md` (scoring numeric-representation and deterministic-replay governance/evidence boundary), `LeaseMind_MATCHING_DECISION_XFR-D-021_v1.0.md` (ranking/diversification governance and qualitative-safeguard boundary), `LeaseMind_MATCHING_DECISION_XFR-D-023_v1.0.md` (Scoring version compatibility/change rules), `LeaseMind_MATCHING_DECISION_XFR-D-024_v1.1.md` (Priority Score optional internal-ordering/input-separation/non-compensation/evidence boundary), `LeaseMind_MATCHING_DECISION_XFR-D-026_v1.0.md` (synthetic-only vs production calibration boundary) и `LeaseMind_MATCHING_DECISION_XFR-D-028_v1.0.md` (Dimension Score explanation ownership boundary) — обязательные governance decisions для соответствующих граней ниже (§5–§6, §9, §12 строки №1/№4/№7/№8/№10/№11/№15/№17, `MSP-C-002`/`MSP-C-003`/`MSP-C-004`/`MSP-C-007`/`MSP-C-010`/`MSP-C-012`/`MSP-C-013`/`MSP-C-017`/`MSP-C-018`/`MSP-C-019`); их approval не переводит этот Proposal в `APPROVED`, не выбирает Mutual Aggregate function и не утверждает numeric formula/threshold/runtime representation/field allowlist.

**Связанные документы:** `LeaseMind_MATCHING_ENGINE_ARCHITECTURE_v1.1.md` (полностью, включая §§5, 8–18, 24, 25, 30–38, 42, 49–53), `LeaseMind_MATCHING_DATA_CONTRACTS_v1.0.md` (прочитан полностью до EOF в рамках предыдущих задач этой сессии; независимо перепроверен на предмет scoring-специфичных терминов — см. §9 ниже), `LeaseMind_MATCHING_FEATURE_SCHEMA_v0.1.md` (Proposal-зависимость), `LeaseMind_MATCHING_EVALUATION_PLAN_v0.1.md` (Proposal-зависимость, threshold-search procedure), `LeaseMind_MATCHING_RISK_POLICY_v0.1.md` (Proposal-зависимость, Risk output boundary), `LeaseMind_MATCHING_QUALIFICATION_POLICY_v0.1.md` (Proposal-зависимость, routing boundary), `LeaseMind_MATCHING_DECISION_XFR-D-017_v1.0.md`, `LeaseMind_MATCHING_DECISION_XFR-D-018_v1.0.md`, `LeaseMind_MATCHING_DECISION_XFR-D-020_v1.0.md`, `LeaseMind_MATCHING_DECISION_XFR-D-021_v1.0.md`, `LeaseMind_MATCHING_DECISION_XFR-D-023_v1.0.md`, `LeaseMind_MATCHING_DECISION_XFR-D-024_v1.1.md`, `LeaseMind_MATCHING_DECISION_XFR-D-026_v1.0.md`, `LeaseMind_MATCHING_DECISION_XFR-D-028_v1.0.md`, `02_PRODUCT/CAMPAIGN_TECHNICAL_ASSIGNMENT.md` (только как источник границы с отдельной pre-launch analysis системой — `deal_probability_30d`/Confidence Engine, не Matching Engine), `05_DEVELOPMENT/matching-engine/reviews/LeaseMind_DEVELOPMENT_REVIEW_MATCHING_ENGINE_v1.1_EIGHTH.md` (только DEVELOPMENT evidence о Data Contracts hash-верификации, не источник новых governance-решений).
...
Список не закрывается произвольно — ни одно решение не сокращено за счёт выдуманного значения. Восемь из этих 18 строк (№1, №4, №8, №10, №11, №15, №16, №17) синхронизированы с human-approved governance decisions `XFR-D-017`/`XFR-D-018`/`XFR-D-021`/`XFR-D-023`/`XFR-D-024 v1.1`/`XFR-D-026`/`XFR-D-027`/`XFR-D-028 v1.0`, layered поверх этого Proposal — сам Proposal остаётся `Proposal for cross-functional review`, не `APPROVED`. №1 разрешён только как Mutual Aggregate qualitative governance/anti-masking/evidence boundary, а harmonic-versus-geometric selection и exact formula/data/metric/statistical/policy/production/runtime contents остаются `OPEN`; №4 разрешён только как qualitative governance/evidence boundary, а actual segment policy/evidence/value/approval остаются `OPEN`; №8 разрешён только как ranking/diversification governance/qualitative-safeguard boundary, а exact algorithm/metric/target/data/production/runtime остаются `OPEN`; №11 разрешён только как Priority Score governance/optional-purpose/three-input-separation/non-compensation/fail-closed/evidence boundary, а all formula/value/activation/ranking/data/production/runtime contents остаются `OPEN`; №16 разрешает только role boundary шагов §30.3 №1–3, оставляя exact procedure/quorum/content открытыми; №18 (`XFR-D-029`) уже задокументирован как anti-pattern guard, отдельного decision record не требует.
